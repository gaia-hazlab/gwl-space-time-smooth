...
stages below are the *statistical* backbone that anchors GWL to the well record: an observation-anchored
random-forest baseline, per-site β-maps for the climate response, and kriging of the residuals. The
closed pixel-wise **water budget** (@sec-hydro-grounds) then adds the *process* coupling — recharge,
