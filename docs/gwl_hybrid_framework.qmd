---
title: |
  The Digital Twin of Soils: Observation-Anchored Groundwater Level, Soil Moisture,
...
date-format: long
abstract: |
  The Digital Twin of Soils — a coupled soil reanalysis as its end product — maintains a *living
...
```{python}
#| label: fig-mission
#| fig-cap: "**The Digital Twin of Soils framework.** Three information streams constrain a
...
recharge from the coupled water budget run over the TerraClimate forcing (@fig-landlab-export).
...
Recharge is exported at the ~4 km TerraClimate forcing scale (a P/PET-dominated flux, so its
