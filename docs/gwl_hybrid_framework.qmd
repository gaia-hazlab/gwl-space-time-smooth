...
date-format: long
abstract: |
  The GAIA Soil Reanalysis maintains a *living hydromechanical state of the subsurface* —
...
```{python}
#| label: fig-mission
#| fig-cap: "**The GAIA Soil Reanalysis framework.** Three information streams constrain a
