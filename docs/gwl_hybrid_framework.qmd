...
capacity, porosity, available water); a Thornthwaite-Mather bucket forced by TerraClimate fills
it through time. The modelled θ reproduces the peer TerraClimate soil-water field at r = 0.98
(a consistency check, shared forcing), with the correct Pacific Northwest signal: wet winters,
late-summer drought, driest 2023, wettest 2010.
...
in the adjacent Cascades give a first independent check: after adding a temperature-index snow
module and calibrating it by leave-one-station-out, the snowiest sites reach r ≈ 0.7–0.8 on the
seasonal phase, with a residual field-capacity dry bias.
...
to the bucket: the model tracks it at domain-mean r = 0.81, the seasonal and 2024/2025
interannual swings lining up, leaving the familiar dry bias.
...
through soil-moisture correlation. On the dynamics side, the demonstrative **dv/v coupling**
awaits real ambient-noise velocity change and borehole-calibrated poroelastic parameters, at
which point it becomes a third, independent estimate of both state variables. Groundwater level
