...
and is released by degree-day spring melt). It lifts the snowiest sites' seasonal skill (e.g.
Park Creek Ridge $r: 0.66 \rightarrow 0.76$; Cayuse Pass $0.67 \rightarrow 0.71$), while the
*pooled* score stays bias-limited — the residual gap is a texture / sensor-depth **bias**, not
snow timing, motivating parameter calibration against SNOTEL SWE and a Cascade domain extension.
