...
The result is a sobering, useful one: **pooled r&nbsp;=&nbsp;0.33**
(788 station-months), with the best sites (e.g. Cayuse Pass,
r&nbsp;=&nbsp;0.67) capturing the seasonal *phase* but a systematic dry bias at the
...
motivates a snow module and a domain extension ([#28](https://github.com/gaia-hazlab/gwl-space-time-smooth/issues/28)).
...
```{=html}
<div class="grid">
  <div class="stat"><div class="n accent">0.33</div><div class="l">independent θ validation (SNOTEL in-situ, uplands) — vs 0.98 shared-forcing consistency</div></div>
  <div class="stat"><div class="n sm">5</div><div class="l">SNOTEL soil-moisture stations, 788 station-months</div></div>
</div>
```
