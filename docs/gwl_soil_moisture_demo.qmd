...
The result is a sobering, useful one: **pooled r&nbsp;=&nbsp;0.34**
...
— e.g. Park Creek Ridge r&nbsp;=&nbsp;0.66&nbsp;→&nbsp;0.76 — while the
*pooled* r stays bias-limited (0.33&nbsp;→&nbsp;0.34):
...
```{=html}
<div class="grid">
  <div class="stat"><div class="n accent">0.34</div><div class="l">independent θ validation (SNOTEL in-situ, uplands) — vs 0.98 shared-forcing consistency</div></div>
  <div class="stat"><div class="n sm">0.66→0.76</div><div class="l">best-site seasonal r, snow module off → on (Park Creek Ridge)</div></div>
</div>
```
...
- **The r&nbsp;=&nbsp;0.98 agreement is a consistency check, not independent validation** — our bucket and
  ...
  The independent check is the SNOTEL comparison above (pooled r≈0.34); SMAP is next ([#29](https://github.com/gaia-hazlab/gwl-space-time-smooth/issues/29)).
