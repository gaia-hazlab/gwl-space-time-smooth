...
(<a href="https://github.com/gaia-hazlab/gwl-space-time-smooth/issues/18">#18</a>), this page shows the science works: <b>GWL and soil moisture
...
field at <b class="sm">r&nbsp;=&nbsp;0.98</b> (per-cell median 0.98) without ever
being fit to it.</div>
...
<div class="grid">
  ...
  <div class="stat"><div class="n sm">0.98</div><div class="l">θ vs independent TerraClimate soil</div></div>
...
- **Independent validation:** our θ tracks TerraClimate's own soil-water field at r&nbsp;=&nbsp;0.98
  (domain mean) / 0.98 (per-cell median) — a strong check, since that field never enters the estimator.
- **Right signal:** wet winters (θ≈0.20), late-summer drought (θ≈0.10); driest
  year 2023, wettest 2010 — the real PNW interannual story.
...
against the independent TerraClimate soil field (bold = 13-month rolling mean; r&nbsp;=&nbsp;0.98).](../figures/demo/soil_moisture_state.png)
...
- The TerraClimate cross-check is an *independent product*, not independent ground truth; SMAP / in-situ
  validation is the next step ([#20](https://github.com/gaia-hazlab/gwl-space-time-smooth/issues/20)).
